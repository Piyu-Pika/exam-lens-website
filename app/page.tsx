    ...
    "@graph": [
      {
        ...
        downloadUrl: "https://github.com/Piyu-Pika/exam-lens-website/releases/download/v1.0.1/app-release.apk",
      },
      {
        "@type": "Organization",
        name: "Exam Lens",
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <a
              href="https://github.com/Piyu-Pika/exam-lens-website/releases/download/v1.0.1/app-release.apk"
